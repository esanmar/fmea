 ...
 * Page class
 */
class suppliers_delete extends suppliers
{
	...
	// Page object name
	public $PageObjName = "suppliers_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("supplierslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("supplierslist.php"); // Return to list
			}
		}
	}
