 ...
 * Page class
 */
class fmea_delete extends fmea
{
	...
	// Page object name
	public $PageObjName = "fmea_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("fmealist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("fmealist.php"); // Return to list
			}
		}
	}
