 ...
 * Page class
 */
class mapping_add extends mapping
{
	...
	// Page object name
	public $PageObjName = "mapping_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("mappinglist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "mappingview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->qualification->CurrentValue = NULL;
		$this->qualification->OldValue = $this->qualification->CurrentValue;
		$this->supplierLevel2->CurrentValue = NULL;
		$this->supplierLevel2->OldValue = $this->supplierLevel2->CurrentValue;
		$this->supplierLevel3->CurrentValue = NULL;
		$this->supplierLevel3->OldValue = $this->supplierLevel3->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['qualification'] = $this->qualification->CurrentValue;
		$row['supplierLevel2'] = $this->supplierLevel2->CurrentValue;
		$row['supplierLevel3'] = $this->supplierLevel3->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// regulation
		$this->regulation->setDbValueDef($rsnew, $this->regulation->CurrentValue, NULL, FALSE);

		// qualification
		$this->qualification->setDbValueDef($rsnew, $this->qualification->CurrentValue, NULL, FALSE);

		// supplierLevel2
		$this->supplierLevel2->setDbValueDef($rsnew, $this->supplierLevel2->CurrentValue, NULL, FALSE);

		// supplierLevel3
		$this->supplierLevel3->setDbValueDef($rsnew, $this->supplierLevel3->CurrentValue, NULL, FALSE);
