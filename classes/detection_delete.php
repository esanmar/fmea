 ...
 * Page class
 */
class detection_delete extends detection
{
	...
	// Page object name
	public $PageObjName = "detection_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detectionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detectionlist.php"); // Return to list
			}
		}
	}
