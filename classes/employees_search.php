 ...
 * Page class
 */
class employees_search extends employees
{
	...
	// Page object name
	public $PageObjName = "employees_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "employeeslist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->workcenter); // workcenter
		if ($srchUrl != "")
			$srchUrl .= "&";
		$srchUrl .= "cmd=search";
		return $srchUrl;
	...
	protected function loadSearchValues()
	{
		...
		if ($this->idFactory->AdvancedSearch->post())
			$got = TRUE;
		if ($this->userlevel->AdvancedSearch->post())
			$got = TRUE;
		if ($this->password->AdvancedSearch->post())
			$got = TRUE;
		if ($this->workcenter->AdvancedSearch->post())
			$got = TRUE;
		return $got;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->name->EditCustomAttributes = "";
			if (!$this->name->Raw)
				$this->name->AdvancedSearch->SearchValue2 = HtmlDecode($this->name->AdvancedSearch->SearchValue2);
			$this->name->EditValue2 = HtmlEncode($this->name->AdvancedSearch->SearchValue2);
			$this->name->PlaceHolder = RemoveHtml($this->name->caption());
			...
			$this->surname->EditCustomAttributes = "";
			if (!$this->surname->Raw)
				$this->surname->AdvancedSearch->SearchValue2 = HtmlDecode($this->surname->AdvancedSearch->SearchValue2);
			$this->surname->EditValue2 = HtmlEncode($this->surname->AdvancedSearch->SearchValue2);
			$this->surname->PlaceHolder = RemoveHtml($this->surname->caption());
			...
			if (!$this->idFactory->Raw)
				$this->idFactory->AdvancedSearch->SearchValue = HtmlDecode($this->idFactory->AdvancedSearch->SearchValue);
			$this->idFactory->EditValue = HtmlEncode($this->idFactory->AdvancedSearch->SearchValue);
			$this->idFactory->PlaceHolder = RemoveHtml($this->idFactory->caption());
			$this->idFactory->EditAttrs["class"] = "form-control";
			$this->idFactory->EditCustomAttributes = "";
			if (!$this->idFactory->Raw)
				$this->idFactory->AdvancedSearch->SearchValue2 = HtmlDecode($this->idFactory->AdvancedSearch->SearchValue2);
			$this->idFactory->EditValue2 = HtmlEncode($this->idFactory->AdvancedSearch->SearchValue2);
			$this->idFactory->PlaceHolder = RemoveHtml($this->idFactory->caption());
			...
			$this->userlevel->EditCustomAttributes = "";
			if (!$Security->canAdmin()) { // System admin
				$this->userlevel->EditValue2 = $Language->phrase("PasswordMask");
			} else {
				$this->userlevel->EditValue2 = $this->userlevel->options(TRUE);
			}
			...
			$this->password->EditCustomAttributes = "";
			if (!$this->password->Raw)
				$this->password->AdvancedSearch->SearchValue2 = HtmlDecode($this->password->AdvancedSearch->SearchValue2);
			$this->password->EditValue2 = HtmlEncode($this->password->AdvancedSearch->SearchValue2);
			$this->password->PlaceHolder = RemoveHtml($this->password->caption());
			...
			if (!$this->workcenter->Raw)
				$this->workcenter->AdvancedSearch->SearchValue = HtmlDecode($this->workcenter->AdvancedSearch->SearchValue);
			$this->workcenter->EditValue = HtmlEncode($this->workcenter->AdvancedSearch->SearchValue);
			$this->workcenter->PlaceHolder = RemoveHtml($this->workcenter->caption());
			$this->workcenter->EditAttrs["class"] = "form-control";
			$this->workcenter->EditCustomAttributes = "";
			if (!$this->workcenter->Raw)
				$this->workcenter->AdvancedSearch->SearchValue2 = HtmlDecode($this->workcenter->AdvancedSearch->SearchValue2);
			$this->workcenter->EditValue2 = HtmlEncode($this->workcenter->AdvancedSearch->SearchValue2);
			$this->workcenter->PlaceHolder = RemoveHtml($this->workcenter->caption());
		}
