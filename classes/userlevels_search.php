 ...
 * Page class
 */
class userlevels_search extends userlevels
{
	...
	// Page object name
	public $PageObjName = "userlevels_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "userlevelslist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->userlevelname); // userlevelname
		if ($srchUrl != "")
			$srchUrl .= "&";
		$srchUrl .= "cmd=search";
		return $srchUrl;
	...
	protected function loadSearchValues()
	{
		...
		if ($this->userlevelid->AdvancedSearch->post())
			$got = TRUE;
		if ($this->userlevelname->AdvancedSearch->post())
			$got = TRUE;
		return $got;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->userlevelname->Raw)
				$this->userlevelname->AdvancedSearch->SearchValue = HtmlDecode($this->userlevelname->AdvancedSearch->SearchValue);
			$this->userlevelname->EditValue = HtmlEncode($this->userlevelname->AdvancedSearch->SearchValue);
