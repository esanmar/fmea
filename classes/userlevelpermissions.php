...
class userlevelpermissions extends DbTable
{
	...
	public function __construct()
	{
		...
		// tablename
		$this->_tablename = new DbField('userlevelpermissions', 'userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, 255, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
