 ...
 * Page class
 */
class processf_edit extends processf
{
	...
	// Page object name
	public $PageObjName = "processf_edit";
	...
	public function run()
	{
		...
		if ($this->TotalRecords <= 0) { // No record found
			...
			$this->terminate("processflist.php"); // Return to list page
	...
	protected function validateForm()
	{
		...
		if (in_array("actions", $detailTblVar) && $GLOBALS["actions"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("actions", $detailTblVar) && $GLOBALS["actions"]->DetailEdit) {
						...
						$editRow = $GLOBALS["actions_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("actions", $detailTblVar)) {
				...
				if ($GLOBALS["actions_grid"]->DetailEdit) {
					$GLOBALS["actions_grid"]->CurrentMode = "edit";
					$GLOBALS["actions_grid"]->CurrentAction = "gridedit";
