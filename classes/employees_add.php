...
class employees_add extends employees
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("idEmployee") !== NULL) {
				$this->idEmployee->setQueryStringValue(Get("idEmployee"));
				$this->setKey("idEmployee", $this->idEmployee->CurrentValue); // Set up key
			} else {
				$this->setKey("idEmployee", ""); // Clear key
