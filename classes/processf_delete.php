 ...
 * Page class
 */
class processf_delete extends processf
{
	...
	// Page object name
	public $PageObjName = "processf_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("processflist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("processflist.php"); // Return to list
			}
		}
	}
