 ...
 * Page class
 */
class causes_delete extends causes
{
	...
	// Page object name
	public $PageObjName = "causes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("causeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("causeslist.php"); // Return to list
			}
		}
	}
