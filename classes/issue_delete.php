 ...
 * Page class
 */
class issue_delete extends issue
{
	...
	// Page object name
	public $PageObjName = "issue_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("issuelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("issuelist.php"); // Return to list
			}
		}
	}
